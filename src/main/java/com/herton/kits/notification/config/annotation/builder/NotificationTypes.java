package com.herton.kits.notification.config.annotation.builder;

import com.herton.kits.notification.config.annotation.AbstractNotificationBuilder;
import com.herton.kits.notification.config.annotation.configurer.MobileAppBroadcastConfigurer;
import com.herton.kits.notification.config.annotation.configurer.SmsBroadcastConfigurer;
import com.herton.kits.notification.config.annotation.configurer.SmsVerifyCodeConfigurer;
import com.herton.kits.notification.config.annotation.configurer.VoiceVerifyCodeConfigurer;
import com.herton.kits.notification.message.MobileAppBroadcastMessage;
