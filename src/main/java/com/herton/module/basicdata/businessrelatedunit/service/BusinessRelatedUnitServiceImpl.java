...
@Component
@Transactional
public class BusinessRelatedUnitServiceImpl extends AbstractCrudService<BusinessRelatedUnit, BusinessRelatedUnitDTO>
    ...
    public void editReceivablePayableAmount(String id, EditReceivablePayableAmountParam editReceivablePayableAmountParam) throws Exception {
        ...
        BusinessRelatedUnitDTO businessRelatedUnit = findOne(id);
